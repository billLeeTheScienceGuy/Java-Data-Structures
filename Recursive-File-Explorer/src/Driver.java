...
/**
 * Interactive command-line interface driver for the FolderExplorer application.
 * @author Bill Lee
 */
public class Driver {
  ...
  private static void getFilePath() {
    ...
    cin.nextLine();
    File folder = new File(cin.nextLine());
    System.out.print("Please designate a file, including its extension: ");
  ...
  public static void main(String[] args) {
    System.out.println("=== Folder Explorer CLI === \n");
    int command = 0;
